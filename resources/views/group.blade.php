...
@section('content')
    	...
    	<div class="toolbar" id="kt_toolbar">
    		...
    		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
    			...
    			<div class="d-flex align-items-center me-3">
    				<!--begin::Title-->
    				<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Group Setup</h1>
    				<!--end::Title-->
    				<!--begin::Separator-->
    				...
    				<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    					...
    					<!--end::Item-->
    					<!--begin::Item-->
    					<li class="breadcrumb-item text-dark">Group Setup</li>
    					<!--end::Item-->
    				</ul>
    				<!--end::Breadcrumb-->
    			</div>
    			...
    			<div class="d-flex align-items-center py-1">
    				...
    				<a class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modal_group" id="btn_group_add">Create</a>
    				@endif
    				<!--end::Button-->
    			</div>
    			<!--end::Actions-->
    ...
    <div class="modal fade" tabindex="-1" id="modal_group">
	            ...
	            success: function (data) {
	                ...
	                for (var i = 0; i < data.length; i++) {
	                    ...
	                    if (priv_group_update) {
		                    ...
		                    element+= '<a class="btn btn-icon btn-success me-2 btn_group_update" data-bs-toggle="modal" data-bs-target="#modal_group" onClick="updateClick(this)"><i class="bi bi-pencil-square fs-4"></i></a>';
	                    }
