...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Management Asset - @yield('title')</title>
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								@if(
									in_array("institution_setup", Session::get('privilege')) ||
									in_array("sensors_setup", Session::get('privilege')) ||
									in_array("institution_sensors_setup", Session::get('privilege'))
									)
								<div class="menu-item">
								...
								@if(in_array("institution_setup", Session::get('privilege')))
								<div class="menu-item">
									<a class="menu-link" href="/institution">
										<span class="menu-icon">
										...
										<span class="menu-title">Institution Setup</span>
									</a>
								</div>
								@endif

								@if(in_array("sensors_setup", Session::get('privilege')))
								<div class="menu-item">
									<a class="menu-link" href="/sensors">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotone/Interface/Settings-02.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<span class="menu-title">Sensors Setup</span>
									</a>
								</div>
								@endif

								@if(in_array("institution_sensors_setup", Session::get('privilege')))
								<div class="menu-item">
									<a class="menu-link" href="/institution_sensors">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotone/Interface/Settings-02.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<span class="menu-title">Institution Sensors Setup</span>
									</a>
								</div>
								@endif

								<!-- <div class="menu-item">
									<a class="menu-link" href="/institution_sensors_map">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path opacity="0.25" d="M2 6.5C2 4.01472 4.01472 2 6.5 2H17.5C19.9853 2 22 4.01472 22 6.5V6.5C22 8.98528 19.9853 11 17.5 11H6.5C4.01472 11 2 8.98528 2 6.5V6.5Z" fill="#12131A" />
										...
										<span class="menu-title">Institution Sensors Map</span>
									</a>
								</div> -->
